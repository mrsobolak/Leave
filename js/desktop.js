...
{id:'cubeyapp',icon:'<svg viewBox="0 0 24 24"><rect x="4" y="8" width="16" height="14" rx="2" fill="#f0e68c" stroke="#b8a43a" stroke-width="1.5"/><rect x="7" y="3" width="10" height="6" rx="1" fill="#333" stroke="#111" stroke-width="1"/><circle cx="9" cy="14" r="2" fill="#fff" stroke="#888" stroke-width="0.5"/><circle cx="15" cy="14" r="2" fill="#fff" stroke="#888" stroke-width="0.5"/><circle cx="9.5" cy="14.5" r="1" fill="#222"/><circle cx="15.5" cy="14.5" r="1" fill="#222"/></svg>',label:'Cubey!',desk:true,menu:true},
