...
{id:'texteditor',icon:'<svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" fill="#ddd" stroke="#888" stroke-width="1"/><path d="M14 2v6h6" fill="#bbb" stroke="#888" stroke-width="1"/><path d="M8 13h8M8 17h8" stroke="#666" stroke-width="1"/></svg>',label:'Notepad',desk:true,menu:true},
{id:'mediaplayer',icon:'<svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="#2a2a5a"/><polygon points="9,6 18,12 9,18" fill="#6cf"/></svg>',label:'Media Player',desk:false,menu:true},
...
{id:'webcam',icon:'<svg viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="14" rx="2" fill="#222" stroke="#555" stroke-width="1"/><circle cx="12" cy="11" r="4" fill="none" stroke="#888" stroke-width="1.5"/><circle cx="12" cy="11" r="1.5" fill="#c00"/><rect x="9" y="2" width="6" height="2" rx="1" fill="#555"/></svg>',label:'Webcam',desk:false,menu:true},
{id:'taskmgr',icon:'<svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="2" fill="#1a1a2a" stroke="#555" stroke-width="1"/><rect x="5" y="14" width="3" height="6" fill="#4a4"/><rect x="10" y="10" width="3" height="10" fill="#aa4"/><rect x="15" y="6" width="3" height="14" fill="#a44"/></svg>',label:'Task Manager',desk:false,menu:true},
{id:'defrag',icon:'<svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="2" fill="#1a1a1a" stroke="#555" stroke-width="1"/><rect x="4" y="4" width="3" height="3" fill="#4a4"/><rect x="8" y="4" width="3" height="3" fill="#44a"/><rect x="12" y="4" width="3" height="3" fill="#a44"/><rect x="16" y="4" width="3" height="3" fill="#4a4"/><rect x="4" y="8" width="3" height="3" fill="#a44"/><rect x="8" y="8" width="3" height="3" fill="#4a4"/><rect x="12" y="8" width="3" height="3" fill="#44a"/><rect x="4" y="12" width="3" height="3" fill="#44a"/><rect x="8" y="12" width="3" height="3" fill="#a44"/></svg>',label:'Defrag',desk:false,menu:true},
{id:'solitaire',icon:'<svg viewBox="0 0 24 24"><rect x="3" y="2" width="14" height="18" rx="2" fill="#fff" stroke="#888" stroke-width="1"/><text x="7" y="12" fill="#c00" font-size="10" font-weight="bold" font-family="serif">&#9829;</text><rect x="9" y="5" width="14" height="18" rx="2" fill="#1a5a1a" stroke="#0a3a0a" stroke-width="1" opacity="0.6"/></svg>',label:'Solitaire',desk:false,menu:true},
{id:'stickynotes',icon:'<svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" fill="#ffff88" stroke="#cccc44" stroke-width="1"/><path d="M6 8h12M6 12h10M6 16h8" stroke="#aa8" stroke-width="1"/></svg>',label:'Sticky Notes',desk:false,menu:true},
{id:'calendar',icon:'<svg viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="18" rx="2" fill="#fff" stroke="#888" stroke-width="1"/><rect x="2" y="4" width="20" height="5" rx="2" fill="#c44"/><rect x="6" y="2" width="2" height="4" rx="1" fill="#666"/><rect x="16" y="2" width="2" height="4" rx="1" fill="#666"/><text x="12" y="18" text-anchor="middle" fill="#333" font-size="10" font-weight="bold" font-family="Arial">28</text></svg>',label:'Calendar',desk:false,menu:true},
{id:'cmd',icon:'<svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="2" fill="#000" stroke="#555" stroke-width="1"/><text x="6" y="14" fill="#ccc" font-size="10" font-family="monospace">C:\&gt;</text></svg>',label:'CMD',desk:false,menu:true}
];
let startOpen=false;
const initDesktop=()=>{
...
document.getElementById('tray-clock').textContent='7:42 PM  9/30/2010';
...
if(window.soosAudio)soosAudio.playDesktop();
};
